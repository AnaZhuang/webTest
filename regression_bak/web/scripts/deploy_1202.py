...
#				driver.find_element_by_xpath("//table[@id='stretch-table']/tbody/tr[@displayname='%s']/td[4]/a[contains(text(),'HTTP')]" % appname).click()
		...
		driver.find_element_by_xpath("//table[@id='stretch-table']/tbody/tr[@displayname='%s']/td[4]/a[contains(text(),'HTTP')]" % "Java1205114308").click() if (self.is_element_present("xpath",u"//span[@title='服务已停止']") == True):
			print "服务已停止"
