...
class Deploy(unittest.TestCase):
	...
	def test_deployApp(self):
		...
		app_operation.operation_start(driver,'Java1213164611','HTTP')
		app_operation.operation_stop(driver,'Java1213164611','HTTP')
#		app_operation.operation_undeploy(driver,'Java1213154949','6451_9206_1297_0116','HTTP')
...
#				else: self.fail("time out")
				...
				app_operation.operation_stop(driver,appname,'HTTP')
