...
class Deploy(unittest.TestCase):
    ...
    def test_deployApp(self):
        ...
        file2.test_filesystem(driver,'Java1213164611')
...
#                #driver.find_element_by_xpath("//td[@id='languageBlock']//dd[2]/input[@type='radio' and @value='%s']" % lg).clear()
#                driver.find_element_by_xpath("//td[@id='languageBlock']//dd[2]/input[@type='radio' and @value='%s']" % lg).click()
#                time.sleep(3)
#                #driver.find_element_by_name("serverType").clear()
#                driver.find_element_by_name("serverType").send_keys(rs)
#                if (db is not None and db!=''):
#                    time.sleep(2)
#                    driver.find_element_by_name("databaseType").clear()
